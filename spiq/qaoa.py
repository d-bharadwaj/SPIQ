...
class QAOASolver:
    def __init__(self, cost_hamiltonian, qaoa_ansatz, sim_device):
        ...
        self.best_spiq_gen_params = None
        self.best_spiq_gen_fitness = None
    ...
    def run_spiq(self, n_gens, out_file=None, n_proc=32, n_starts=4, n_rounds=1):
        ...
        (
            ...
            self.energy_best,
            self.best_spiq_gen_params,
            self.best_spiq_gen_fitness,
        ) = claptonize(
            reversed_paulis,
            coeffs,
            self.stim_circ,
        ...
        print(f"Minimum Energy found with SPIQ initialization: {self.energy_best}")
