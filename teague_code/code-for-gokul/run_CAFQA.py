...
def main():
    ...
    best_cafqa_fitness_values = teague_qaoa.best_cafqa_gen_fitness[::-1]
    best_cafqa_parameters = teague_qaoa.best_cafqa_gen_params[::-1]
    ...
    output_data = {
        ...
        "best_cafqa_parameters": best_cafqa_parameters,
        "CAFQA_initialization_energy" : teague_qaoa.energy_best
    }
