...
for noise_level in noise_levels:
    random_result, random_obj_values = maxcut_qaoa.run_qaoa(
        initial_params=random_angles, err=noise_level, max_iters=max_iters, noise=noise
    )
    cafqa_result, cafqa_obj_values = maxcut_qaoa.run_qaoa(
        initial_params=cafqa_params, err=noise_level, max_iters=max_iters, noise=noise
    )
    ...
    np.save(
        os.path.join(output_dir, f"new_results_{seed}_noise_{noise_level}.npy"), result
    )
