...
cobyla_result, cobyla_obj_values = maxcut_qaoa.run_qaoa(initial_params=cafqa_params,max_iters=max_iters, opt = "COBYLA")
spsa_result, spsa_obj_values = maxcut_qaoa.run_qaoa(initial_params=cafqa_params,max_iters=max_iters, opt = "SPSA")
bfgs_result, bfgs_obj_values = maxcut_qaoa.run_qaoa(initial_params=cafqa_params,max_iters=max_iters, opt = "COBYQA")
