...
from clapton.circuit_manipulation import transform_qiskit_to_stim, multi_angle_qaoa_circuit, multi_angle_qaoa_plus_circuit, generate_qiskit_param_map
...
ma_qaoa_plus_stim_circ,ma_qaoa_plus_pcirc = transform_qiskit_to_stim(ma_qaoa_plus_circuit)
